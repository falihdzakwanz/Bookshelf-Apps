...
function addBook() {
    ...
    const booksObject = generateBooksObject(generatedID, textTitle, textBookAuthor, year, false);
...
function makeBook(booksObject) {
    ...
    bookArticle.setAttribute('id', `book-${bookId}`);
    ...
    trashButton.setAttribute('src', 'assets/trash-bin.png');
    ...
    editButton.setAttribute('src', 'assets/pen.png');
